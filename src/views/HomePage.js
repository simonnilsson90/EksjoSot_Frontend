    ...
    return (
        <div className="home-page">
            ...
            <div className={"hero-text"}>
                ...
                <h3>The store where you can buy any type of training data for your AI models</h3>
            </div>
            ...
            <div className="features-section">
                ...
                <div className="features-grid">
                    <div className='feature'>
                        ...
                        <p>The Everyone Store is a marketplace that offers a wide range of personal data sets.</p>
                    </div>
                    <div className='feature'>
                    ...
                    <div className='feature'>
                        ...
                        <h3>AI models</h3>
                        <p>Use the data sets to train your AI models and create more realistic and human-like models</p>
                    </div>
                    <div className='feature'>
                        <img src={feature4} alt="Feature 4"/>
                        <h3>And more</h3>
                        <p>There are many other uses for personal data sets. The possibilities are endless.</p>
                    </div>
                </div>
            </div>
        </div>
