    ...
    <div className="relative h-screen bg-cover bg-top bg-fixed" style={{ backgroundImage: "url('/sunrise_sotare.jpeg')" }}>
      <div className="absolute inset-0 bg-gradient-to-b from-black/90 via-transparent to-transparent">
        <div className="flex flex-col md:items-center items-center lg:items-start lg:pl-12 lg:pr-4 pt-20">
          <div className="text-center md:text-center lg:text-left lg:absolute lg:right-14 lg:top-24">
          ...
          <div style={{ backgroundColor: "#2b2f32" }} className=" mt-80 rounded-lg mx-5 lg:ml-4 p-2 lg:w-2/5 text-gray-100 lg:text-3xl text-xl font-semibold">
