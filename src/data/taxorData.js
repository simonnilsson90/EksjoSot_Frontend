const taxorData = {
    ...
    howWeStandOut: {
      ...
      items: [
        ...
        "Ethical Standards: Compliance with international data protection laws like GDPR is not just a requirement but a core part of our ethos. We ensure that all data is collected and used in an ethical manner, respecting the privacy and rights of the data providers.",
      ]
    },
    ourCulture: {
      title: "TAXEHÖJNING",
