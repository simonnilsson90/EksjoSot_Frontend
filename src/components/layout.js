    ...
    return (
        <div>
            <div className="flex flex-col gap-4   lg:w-full md:w-full lg:mb-16 md:mb-16 lg:mt-10 md:mt-10 mt-20 lg:flex-row md:flex-row lg:flex-wrap md:flex-wrap">
                <div className="text-white mx-auto lg:mt-10 md:mt-10 lg:flex md:flex  md:w-5/6 lg:mx-auto md:mx-auto">
                    <h1 className="text-5xl text-start pb-2 lg:pb-0 md:pb-0 lg:border-none md:border-none lg:text-7xl md:text-7xl border-sotOrange border-b-2 ">{title}</h1>
                    <div className="hidden lg:block md:block mt-4 mx-2 lg:text-2xl md:text-2xl lg:text-start md:text-start lg:mt-48 md:mt-40 lg:ml-56 lg:right-1 md:right-4  ">
                        {pretext}
                    </div>
                </div>
                <div className="section bg-black  text-white lg:mx-0 md:mx-0  lg:mt-32 md:mt-16 mt-28">
